...
const getFulfillment = (fulfilment: Order["fulfilment"]) => {
    if (!fulfilment.date || fulfilment.interval) {
        return ""
    }
    ...
    <div class="section">
        ...
        <p><strong>Date:</strong> ${fulfilment.date}</p>
        <p><strong>Time:</strong> ${fulfilment.interval}</p>
    </div>
    `)
}
    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <p><strong>Maistro Order:</strong> <br>
                <a href="https://maistro.website/en/projects/${order.projectId}/orders/${order.id}" class="button">View Order Details</a>
            </p>
        </div>
        ...
        ${getFulfillment(order.fulfilment)}
        ...
        <div class="section">
            ...
            <p>${order.customerDetails.address.state}</p>
