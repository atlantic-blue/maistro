...
interface EmailListsUpdateByIdInput {
    title: string
    description: string
}
...
const emailListsUpdateById: APIGatewayProxyHandler = async (event: APIGatewayProxyEvent) => {
    ...
    const { title, description } = event.body as unknown as EmailListsUpdateByIdInput;
...
const validationSchema = Joi.object<EmailListsUpdateByIdInput>({
