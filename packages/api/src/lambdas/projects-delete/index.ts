...
const deleteById: APIGatewayProxyHandler = async (event: APIGatewayProxyEvent) => {
    ...
    const { id } = event.body as unknown as ProjectsDeleteInput;
...
const validationSchema = Joi.object<ProjectsDeleteInput>({
