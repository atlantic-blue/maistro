...
const i18nConfig: I18nConfig = {
  en: {
    ...
    step2: {
      ...
      categories: {
        fashion: "Fashion, Accessories, and Jewelry 👗",
        wellness: "Health and Wellness 🌿",
        gastronomy: "Gastronomy and Pastry 🍰",
        sports: "Sports 🏃‍♂️",
    ...
    step4: {
      ...
      teamSizes: ["2-5 people", "6-10 people", "11+ people"],
      helpText:
    ...
    step5: {
      ...
      fields: {
        ...
        description: {
          ...
          placeholder:
            "Tell clients about your business, atmosphere, and what makes you special...",
        },
      },
    },
    step6: {
      ...
      description:
        "Select the services you offer. You can customize these later.",
      addCustomService: "+ Add custom service",
      saveCustomService: "+ Save service",
      currency: "£",
      services: {
        "hair-salon": [
    ...
    step7: {
      ...
      description:
        "Select any special features or amenities your business offers.",
      features: [
        "Pet-friendly",
        "Eco-conscious",
    ...
    step8: {
      ...
      description: "Welcome to Maistro!",
  ...
  es: {
    ...
    step1: {
      ...
      description:
        "Este es el nombre de marca que verán tus clientes. Tu nombre legal y de facturación se puede agregar más tarde.",
      fields: {
        businessName: {
    ...
    step2: {
      ...
      categories: {
        fashion: "Moda, Accesorios y Joyería 👗",
        wellness: "Salud y Bienestar 🌿",
        gastronomy: "Gastronomía y Repostería 🍰",
        sports: "Deportes 🏃‍♂️",
    ...
    step4: {
      ...
      teamSizes: ["2-5 personas", "6-10 personas", "11+ personas"],
      helpText:
        "Te ayudaremos a configurar perfiles de personal y horarios para organizar tu equipo de manera eficiente.",
    },
    step5: {
      title: "Establece la ubicación física de tu local",
      description:
        "Agrega la ubicación principal de tu negocio para que tus clientes puedan encontrarte fácilmente.",
      fields: {
        address: {
        ...
        phone: {
          ...
          placeholder: "+57 300 221 7511",
        },
        description: {
          label: "Descripción del Negocio",
          placeholder:
            "Cuéntales a los clientes sobre tu negocio, ambiente y qué te hace especial...",
        },
      },
    },
    step6: {
      ...
      description:
        "Selecciona los servicios que ofreces. Puedes personalizarlos más tarde.",
      addCustomService: "+ Agregar servicio personalizado",
      saveCustomService: "+ Guardar servicio",
      currency: "COP",
      services: {
        "hair-salon": [
    ...
    step7: {
      ...
      description:
        "Selecciona cualquier característica especial o amenidad que ofrezca tu negocio.",
      features: [
        "Acepta mascotas",
        "Eco-consciente",
    ...
    step8: {
      ...
      description: "¡Bienvenido a Maistro!",
