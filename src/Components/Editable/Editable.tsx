        ...
        <div
            ...
            onMouseLeave={() => {
                setTimeout(() => {
                    /**
                     * TODO:
                     * find a better solution to this hack!
                     * when the user is uploading an image
                     * the website will blur out (onmouseleave)
                     * when the upload banner appears, this triggers
                     * a re render thus losing the current state
                     */
                    saveContent()
                }, 1000 * 20); // seconds
            }}
