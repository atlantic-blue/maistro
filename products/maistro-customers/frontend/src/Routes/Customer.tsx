...
import { CalendarIcon, ChatBubbleIcon, EnvelopeClosedIcon } from "@radix-ui/react-icons"
...
avatar: "https://lh3.googleusercontent.com/a/ACg8ocJE_jO3gCtQNnJXCUX111cyWR9vO9Pp6aCyyRy4tsh-07ce6JQNjw=s96-c",
...
<Card className="mb-6">
    <Flex gap="6" align="start">
      ...
      <Box className="flex-1">
        <Heading size="6" className="mb-2">{customer.name}</Heading>
        <Text size="3" color="gray" className="mb-4">{customer.email}</Text>
        
        <Grid columns="2" gap="4">
          <Box>
            <Text size="2" color="gray">Company</Text>
            <Text size="3" weight="medium">{customer.company}</Text>
          </Box>
          <Box>
          ...
          <Box>
            <Text size="2" color="gray">First Contact</Text>
