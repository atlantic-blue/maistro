  ...
  return (
    ...
    >
      <div>
        ...
        <h1 className="text-4xl font-bold text-gray-900 mb-4">{resourceStrings.step3.title}</h1>
        <p className="text-gray-600 mb-12">{resourceStrings.step3.description}</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
          ...
          >
            <Users className="w-8 h-8 mb-4 mx-auto text-gray-600" />
            <h3 className="font-medium text-gray-900">{resourceStrings.step3.options.team}</h3>
          </button>
        </div>
      </div>
    </StepWrapper>
